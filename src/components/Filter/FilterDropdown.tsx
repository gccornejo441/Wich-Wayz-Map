...
export function FilterDropdown({ open, navRef, onFilterChange }: FilterDropdownProps) {
    ...
    return (
        <div
            className="fixed left-0 z-40 shadow-md w-screen bg-lightGray transition-all duration-300 max-h-[20rem] md:max-h-[30rem] overflow-y-auto border-t border-lightGray"
            style={{ top }}
        >
