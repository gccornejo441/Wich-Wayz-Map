      ...
      <div className="bg-surface-light dark:bg-surface-dark rounded-lg shadow-xl max-w-lg w-full mx-4 p-6">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            onClick={handleCopy}
            disabled={copied}
            className={`px-4 py-2 rounded-lg font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-brand-secondary flex items-center gap-2 ${copied
