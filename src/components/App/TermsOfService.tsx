const TearmsOfService = () => {
  return (
    <article className="prose max-w-3xl mx-auto">
      ...
      <div className="grow">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 tracking-snug leading-tight md:leading-tight">
          Wich Wayz Terms of Use
        </h1>
        <div className="pt-10 prose prose-lg prose-blue text-gray-700">
          <p>
            <em>Last updated December 06, 2024</em>
          </p>
          <p>Thank you for using Wich Wayz!</p>
          <p>
            These Terms of Use, in conjunction with our{" "}
            <a href="/privacy">Privacy Notice</a>,{" "}
            <a href="/eula">End User License Agreement</a>, and the{" "}
            <a href="/dpa">Data Processing Addendum</a> incorporated herein by
            this reference, constitute a legally binding agreement made between
            you, whether personally or on behalf of an entity (“you”) and Wich
            Wayz, Inc. (“Wich Wayz”, “we”, “us”, or “our”), concerning your
            access to and use of the{" "}
            <a href="https://WichWayz.com">Wich Wayz.com</a> website as well as
            any other media form, media channel, browser extension, mobile
            website or mobile application related, linked, or otherwise
            connected thereto (collectively, the “Website”, “Site”, or
            “Services”). Here are a few additional terms you’ll find throughout
            this document:
          </p>
          <ul>
            <li>
              Wich Wayz “Users” (also referred to as “Customers”) are people who
              have registered for an account,
            </li>
            <li>
              Wich Wayz “Schedulers” are people who have booked a meeting with a
              User, but may not have registered for an account of their own, and
            </li>
            <li>
              Wich Wayz “Viewers” are people who visit the Website, buy may not
              be a User or Scheduler.
            </li>
          </ul>
          <p>
          ...
          <h2 id="acceptable-use" tabIndex={-1}>
            Acceptable Use
          </h2>
          <p>
            Wich Wayz faciliates the scheduling of meetings between Wich Wayz
            Users and Schedulers. You may use these Services for your individual
            purposes and not for the purpose of reselling.
          </p>
          <h2 id="intellectual-property-rights" tabIndex={-1}>
            Intellectual Property Rights
          </h2>
          <p>
            Wich Wayz claims no intellectual property rights over the data You
          ...
          <p>
            ...
            patent rights and design rights related to the Site are the
            exclusive property of Wich Wayz or its licensors and are subject to
          ...
          <p>
            ...
            appearing in connection with Wich Wayz are, and remain, the
            exclusive property of Wich Wayz or its licensors and are subject to
            the protection granted by applicable laws or international treaties
            related to intellectual property.
          </p>
          <h2 id="user-registration" tabIndex={-1}>
            User Registration
          </h2>
          <p>
            In order to create scheduling links to faciliate booking events, you
            will need to register for an account with Wich Wayz. You agree to
            ...
            reclaim, or change the individual or team URL you select if we
            determine, in our sole discretion, that such a URL is inappropriate,
            obscene, or otherwise objectionable.
          </p>
          <p>
            By using Wich Wayz, you represent and warrant that: (1) all
            registration information you submit will be true, accurate, current,
            and complete; (2) you will maintain the accuracy of such information
            and promptly update such registration information as necessary; (3)
            you have the legal capacity and you agree to comply with these Terms
            of Use; (4) you are not a minor in the jurisdiction in which you
            reside; (5) you will not access Wich Wayz through automated or
            non-human means, whether through a bot, script or otherwise; (6) you
            will not use Wich Wayz for any illegal or unauthorized purpose; and
            (7) your use of Wich Wayz will not violate any applicable law or
            regulation.
          </p>
          <p>
            If you provide any information that is untrue, inaccurate, not
            current, or incomplete, we have the right to suspend or terminate
            your account and refuse any and all current or future use of Wich
            Wayz (or any portion thereof).
          </p>
          <h2 id="fees-%26-payment" tabIndex={-1}>
            Fees &amp; Payment
          </h2>
          <p>
            You may be required to purchase or pay a fee to access some of our
            services as described on our <a href="/pricing">pricing page</a>.
            You agree to provide current, complete, and accurate purchase and
            account information for all purchases made via Wich Wayz. You
            ...
            made via Wich Wayz. Sales tax will be added to the price of
          ...
          <p>
            ...
            reserve the right to refuse any order placed through Wich Wayz.
          </p>
          <h2 id="renewal-%26-cancellation" tabIndex={-1}>
            Renewal &amp; Cancellation
          </h2>
          <p>
            Subscriptions will automatically renew for the same subscription
            period unless you cancel the account by the end of the then-current
            subscription period. You can cancel your subscription at any time by
            logging into your account and accessing{" "}
            <a href="/billing">the “Billing” page</a>, which is available under
            the “Settings” navigation, or contacting us at
            wich.wayz.map@gmail.com. Your cancellation will take effect at the
            end of the current paid term. After you cancel your account, you may
            not be able to use or access our Services.
          </p>
          <h2 id="electronic-communications" tabIndex={-1}>
            Electronic Communications
          </h2>
          <p>
            Using Wich Wayz services, sending us emails, and completing online
          ...
          <h2 id="prohibited-activities" tabIndex={-1}>
            Prohibited Activities
          </h2>
          <p>
            You may not access or use Wich Wayz for any purpose other than that
            for which we make Wich Wayz available. Wich Wayz may not be used in
            connection with any commercial endeavors except those that are
            specifically endorsed or approved by us. Violating these terms may
            result in suspension or deletion of your Wich Wayz account.
          </p>
          <p>As a user of Wich Wayz, you agree not to:</p>
          <ul>
            <li>
              Systematically retrieve data or other content from Wich Wayz to
            ...
            <li>
              ...
              features of Wich Wayz, including features that prevent or restrict
              the use or copying of any Content or enforce limitations on the
              use of Wich Wayz and/or the Content contained therein.
            </li>
            <li>
            ...
            <li>
              Use any information obtained from Wich Wayz in order to harass,
            ...
            <li>
              Use Wich Wayz in a manner inconsistent with any applicable laws or
              regulations.
            </li>
            <li>Engage in unauthorized framing of or linking to Wich Wayz.</li>
            <li>
              ...
              enjoyment of Wich Wayz or modifies, impairs, disrupts, alters, or
              interferes with the use, features, functions, operation, or
              maintenance of Wich Wayz.
            </li>
            <li>
            ...
            <li>
              Interfere with, disrupt, or create an undue burden on Wich Wayz or
              the networks or services connected to Wich Wayz.
            </li>
            <li>
              Harass, annoy, intimidate, or threaten any of our employees or
              agents engaged in providing any portion of Wich Wayz to you.
            </li>
            <li>
              Attempt to bypass any measures of Wich Wayz designed to prevent or
              restrict access to Wich Wayz, or any portion of Wich Wayz.
            </li>
            <li>
              Copy or adapt Wich Wayz’s software, including but not limited to
              HTML, JavaScript, or other code.
            </li>
            <li>
              Except as permitted by applicable law, decipher, decompile,
              disassemble, or reverse engineer any of the software comprising or
              in any way making up a part of Wich Wayz.
            </li>
            <li>
              Except as may be the result of standard search engine or Internet
              browser usage, use, launch, develop, or distribute any automated
              system, including without limitation, any spider, robot, cheat
              utility, scraper, or offline reader that accesses Wich Wayz, or
              using or launching any unauthorized script or other software.
            </li>
            <li>
              Use a buying agent or purchasing agent to make purchases on Wich
              Wayz.
            </li>
            <li>
              Make any unauthorized use of Wich Wayz, including collecting
              usernames and/or email addresses of users by electronic or other
              means for the purpose of sending unsolicited email, or creating
              user accounts by automated means or under false pretenses.
            </li>
            <li>
              Use Wich Wayz as part of any effort to compete with us or
              otherwise use Wich Wayz and/or the Content for any
            ...
            <li>
              ...
              or childbirth, and related medical conditions), sexual
              orientation, veteran or military status, and genetic information
              (including familial genetic information); and
            </li>
            <li>
              ...
              definition of “special categories of data” under EU Data
              Protection Laws, “protected health information” under California
              or other relevant law or regulations. “Special categories of data”
              include, for example, information about an individual’s race,
              ethnic origin, politics, religion, trade union membership,
              genetics, biometrics, health, sex life, sexual orientation, or
              criminal records.
            </li>
          </ul>
          <h2 id="links-to-third-party-websites" tabIndex={-1}>
            Links to Third-Party Websites
          </h2>
          <p>
            Wich Wayz may contain (or you may be sent via Wich Wayz) links to
            ...
            Third-Party Websites accessed through Wich Wayz or any Third-Party
            Content posted on, available through, or installed from Wich Wayz,
          ...
          <p>
            If you decide to leave Wich Wayz and access the Third-Party Websites
            ...
            navigate from Wich Wayz or relating to any applications you use or
            install from Wich Wayz. Any purchases you make through Third-Party
          ...
          <h2 id="indemnification" tabIndex={-1}>
            Indemnification
          </h2>
          <p>
          ...
          <h2 id="limitation-of-liability" tabIndex={-1}>
          ...
          <h2 id="governing-law" tabIndex={-1}>
            Governing Law
          </h2>
          <p>
            These Terms of Use and your use of Wich Wayz are governed by and
            construed in accordance with the laws of the State of Minnesota
            applicable to agreements made and to be entirely performed within
            the State of Minnesota, without regard to its conflict of law
            principles.
          </p>
          <h2 id="force-majeure" tabIndex={-1}>
            Force Majeure
          </h2>
          <p>
            Neither party shall be responsible for any failure to perform, or
            delay in performing any of its obligations under these Terms, where
            and to the extent that such a failure or delay results from causes
            outside the control of such party. Such causes shall include,
            without limitation, failures caused by a third-party service, acts
            of God or of the public enemy, acts of the government in its
            sovereign or contractual capacity, fires, floods, epidemics,
            quarantine restrictions, freight embargoes, strikes, civil commotion
            or the like.
          </p>
          <h2 id="dispute-resolution" tabIndex={-1}>
            Dispute Resolution
          </h2>
          <h3 id="binding-arbitration" tabIndex={-1}>
            Binding Arbitration
          </h3>
          <p>
            ...
            applicable law, the arbitration will take place in Hennepin,
            Minnesota. Except as otherwise provided herein, the Parties may
          ...
          <p>
            ...
            state and federal courts located in Hennepin, Minnesota, and the
          ...
          <h3 id="exceptions-to-arbitration" tabIndex={-1}>
          ...
          <h2 id="choice-of-law" tabIndex={-1}>
            Choice of Law
          </h2>
          <p>
            You agree that all disputes or proceedings related in any way to or
            arising from Your use of the Service shall be governed, without
            respect to conflict of law principles, by the laws of the State of
            Minnesota; provided, however, that any disputes or proceedings
            arising under the DPA shall be governed by its terms, including with
            respect to choice of law and jurisdiction.
          </p>
          <h2 id="california-users-and-residents" tabIndex={-1}>
          ...
          <h2 id="changes" tabIndex={-1}>
            Changes
          </h2>
          <p>
            We may amend our Terms at any time by publishing revised Terms on
            our Website and/or by sending an email to the address you gave us.
            These Terms are current as of the “Last updated” date set forth
            above. If any changes are made to these Terms, we’ll post them on
            this page, so please be sure to check back from time-to-time. If you
            continue to use Wich Wayz after those changes are in effect, you
            agree to the revised Terms. If you object to any such modifications,
            your sole recourse will be to cease using this Website. Wich Wayz
            reserves the right to change any and all features of our Services,
            at any time, without prior notice.
          </p>
          <h2 id="severability" tabIndex={-1}>
            Severability
          </h2>
          <p>
          ...
          <h2 id="contacting-us" tabIndex={-1}>
            Contacting Us
          </h2>
          <p>
            In order to resolve a complaint regarding the Site or to receive
            further information regarding use of Wich Wayz, please contact us at
            wich.wayz.map@gmail.com.
          </p>
        </div>
      </div>
    </article>
