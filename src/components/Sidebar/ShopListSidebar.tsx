...
const SavedShopSidebar = ({ isOpen }: SidebarProps) => {
    ...
    return (
        <aside
            className={`fixed top-8 left-0 z-30 w-64 h-screen bg-primary dark:bg-dark border-primary border-r dark:border-gray-700 transition-all duration-500 ease-in-out transform shadow-2xl shadow-black-500 ${isOpen ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0"
                }`}
